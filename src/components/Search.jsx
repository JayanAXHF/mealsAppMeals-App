...
const Search = () => {
  return (
    <form className="relative md:block hidden">
      ...
      <span className="grid gap-3 grid-flow-col">
        <input
          type="text"
          id="search-navbar"
        ...
        <button
          type="submit"
          className="text-white  self-end bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
        >
          Search
        </button>
        <button
